 ...
 */
        ...
        var ce = function(t, e) {
            ...
            return n ? o ? Math.min(l, 1) : Math.max(-l, -1) : o ? l : -l;
        };
        ...
        var Pr = {
            ...
            priceVariations: function(t, e) {
                0 === e && (t.priceBased = dr(new Set([].concat(dr(t.priceBased), [ "mid_price_open_close", "mid_price_high_low" ]))), 
                Object.assign(t.verticalOhlcv, {
                    mid_price_open_close: dr(t.nullArray),
                    mid_price_high_low: dr(t.nullArray)
                }));
            ...
            macd: function(t, e, r, n, o, i) {
                ...
                if (0 === e) {
                    ...
                    // Choose a display prefix based on the number of indicators.
                        ...
                        settings: {}
                    }), l.macd.settings[s] = new zt(new Dt(r), new Dt(n), new Dt(o)), Object.assign(u, me(me(me({}, b, ge(y)), m, ge(y)), g, ge(y))), 
                    p.push(b, m, g);
                }
            ...
            bollingerBands: function(t, e, r, n, o) {
                ...
                if (0 === e) {
                    ...
                    Object.assign(E, function(t) {
                        ...
                        return t;
                    }({}, R)), b > 0 && t.lag(x, b), j.push("".concat(f, "_upper"), "".concat(f, "_middle"), "".concat(f, "_lower"));
                }
            ...
            candleVectors: function(t, e, r, n) {
                ...
                if (0 === e) {
                    ...
                    for (var y = t.nullArray, p = [ [ "close", "open" ], [ "close", "high" ], [ "close", "low" ], [ "open", "high" ], [ "open", "low" ], [ "high", "low" ] ], v = [ [ "open", "open" ], [ "high", "high" ], [ "low", "low" ], [ "close", "close" ] ].concat(p), d = [], b = {}, m = 0; m < i; m++) {
                        var g, w = Ke(v);
                        try {
                            for (w.s(); !(g = w.n()).done; ) {
                                var O = Fe(g.value, 2), S = O[0], _ = O[1];
                                d.push("candle_change_".concat(m + 1, "_").concat(S, "_").concat(_)), b["candle_change_".concat(m + 1, "_").concat(S, "_").concat(_)] = $e(y), 
                    ...
                    var T = [].concat(j, d);
                    Object.assign(c, ze(ze({}, P), b)), Object.assign(s, {
                        candleVectors: {
                            bodyVectors: p,
                            lookBackVectors: v,
                            keyNames: T,
 ...
 // Optionally: throw an error if type is not recognized
            ...
            for (var s = function(t) {
                ...
                var h = t[f], y = h.open, p = h.high, v = h.low, d = h.close, b = wr(h, mr), m = e.precisionMultiplier, g = Ar(y, e.inputTypes.open, m), w = Ar(p, e.inputTypes.high, m), O = Ar(v, e.inputTypes.low, m), S = Ar(d, e.inputTypes.close, m);
        ...
        var Nr = [ .001, .002, .0025, .005, .01, .02, .025, .05, .1, .2, .25, .5, 1, 2, 2.5, 5, 10 ], Lr =  function() {
            return t = function t(e) {
                ...
                this.compute()), this.inputParams = [], this.pushToMain = function(t) {
                    ...
                    return function(t) {
                        var e = t.main, r = t.index, n = t.key, o = t.value, i = e.precision, a = e.priceBased, u = e.minMaxRanges, l = e.verticalOhlcv, c = e.autoMinMaxKeys;
                        if (e.invalidValueIndex, null == o) for (var s in u) u[s] = {
                            min: 1 / 0,
                            max: -1 / 0
                        };
                        if (l[n][r] = o, "number" == typeof o && !n.includes("_x_")) {
                            var f = c.includes(n);
                            if (n.includes("_diff_") && f) u.hasOwnProperty(n) && u[n].min !== 1 / 0 && u[n].max !== -1 / 0 || (u[n] = {
                                min: -1,
                                max: 1
                            }); else if (n.startsWith("candle_") && f) u[n] = {
                                min: -1,
                                max: 1
                            }; else if (n.includes("_range_") && f) u[n] = {
                                min: 0,
                                max: 1
                            }; else if (n.startsWith("rsi_") && f) u[n] = {
                                min: 0,
                                max: 1
                            }; else {
                                var h = i && a.includes(n) ? o / precisionMultiplier : o;
                ...
                value: function() {
                    ...
                    var n = r.target, o = void 0 === n ? "close" : n, a = r.height, u = void 0 !== a && a, l = r.range, c = void 0 === l ? [] : l, s = r.scale, f = void 0 === s ? null : s, h = r.lag, y = void 0 === h ? 0 : h, p = r.autoMinMax;
                    ...
                    if ("number" != typeof y) throw new Error('"lag" value in rsi must be a number in bollingerBands.');
                    if ("boolean" != typeof p) throw new Error('"autoMinMax" value in rsi must be a number in bollingerBands.');
                ...
                key: "candleVectors",
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 20, e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    if (i(this), "number" != typeof t || t <= 0) throw new Error('"size" must be a positive number greater than 0 in candleVectors.');
                    var r = e.stdDev, n = void 0 === r ? .5 : r, o = e.lag, a = void 0 === o ? 0 : o, u = e.scale, l = void 0 === u ? .05 : u, c = e.patternSize, s = void 0 === c ? 1 : c, f = e.autoMinMax, h = void 0 !== f && f;
