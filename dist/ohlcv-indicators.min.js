 ...
 */
        ...
        var C =  function() {
            return k((function t() {
                ...
                key: "getResult",
                value: function() {
                    if (void 0 === this.result) throw new E;
                    return this.result;
                }
            }, {
                key: "setResult",
        ...
        function At(t, e, r) {
            return e && Et(t.prototype, e), r && Et(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
        }
        function Mt(t, e, r) {
        ...
        var Dt =  function(t) {
            ...
            return Tt(e, t), At(e, [ {
                ...
                key: "getResult",
                value: function() {
                    if (this.pricesCounter < this.interval) throw new E;
                    return this.result;
                }
            }, {
                key: "isStable",
        ...
        var ce = function(t, e) {
            ...
            var i = n > 0, a = Math.abs(n);
            if (o ? t[e][t[e].length - 1] = a : t[e].push(a), t[e].length > r && t[e].shift(), 
            t[e].length < r) return null;
            var u = t[e].reduce((function(t, e) {
                return t + e;
            }), 0) / r, l = Math.sqrt(t[e].reduce((function(t, e) {
                return t + Math.pow(e - u, 2);
            }), 0) / r), c = (a - u) / l;
            return i ? c : -c;
        };
        ...
        function xe(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = ke(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        function ke(t, e) {
            if (t) {
                ...
                var r = {}.toString.call(t).slice(8, -1);
                return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r || "Set" === r ? Array.from(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? Te(t, e) : void 0;
            }
        }
        function Te(t, e) {
            (null == e || e > t.length) && (e = t.length);
        ...
        function Ve(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = Be(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        function Be(t, e) {
            if (t) {
                ...
                var r = {}.toString.call(t).slice(8, -1);
                return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r || "Set" === r ? Array.from(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? Ne(t, e) : void 0;
            }
        }
        function Ne(t, e) {
            (null == e || e > t.length) && (e = t.length);
        ...
        function Ge(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = Je(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        var nr = function(t, e) {
            ...
            try {
                for (g.s(); !(m = g.n()).done; ) {
                    var w, O = Xe(m.value, 2), S = O[0], j = O[1], _ = Ze(S);
                    try {
                        for (_.s(); !(w = _.n()).done; ) {
                            var P = w.value, E = n[P];
                            // Initialize lagged arrays only on the first index
                            if (0 === e) for (var A = 1; A <= j; A++) {
                                n["".concat(P, "_lag_").concat(A)] = Qe(o);
                            }
                            // Populate lagged values
                                                        for (var M = 1; M <= j; M++) {
                                var x = "".concat(P, "_lag_").concat(M), k = e - M, T = k <= 0 || void 0 === E[k] ? null : E[k];
                                t.pushToMain({
                                    index: e,
                                    key: x,
                                    value: T
        ...
        }, dr = [ "open", "high", "low", "close" ];
        function mr(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = Sr(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        var _r = {
            dateTime: function(t, e) {
                ...
                var a = n.date[e], u = br(a), l = u.day_of_the_week, c = u.day_of_the_month, s = u.week_of_the_month, f = u.month, h = u.year, y = u.hour, p = a.slice(0, 10);
            ...
            movingAverages: function(t, e, r, n, o) {
                var i = o.target, a = o.diff, u = t.verticalOhlcv, l = t.instances, c = t.priceBased, s = t.lastIndexReplace, f = "string" == typeof i && u.hasOwnProperty(i) && "close" !== i ? "_".concat(i) : "", h = "".concat(r, "_").concat(n).concat(f), y = "".concat(r, "_").concat(n, "_diff").concat(f);
                if (0 === e) {
                    var p = t.nullArray;
                ...
                if (t.pushToMain({
                    ...
                    var _, P = he(a.targets);
                    try {
                        for (P.s(); !(_ = P.n()).done; ) {
                            var E = _.value, A = null;
                            // Compute diffValue only if we have a valid MA value.
                                                        null !== j && "number" == typeof j && (A = u[E][e] - j), 
                            // Update the diff indicator only if diffValue is a valid number.
                            null !== A && "number" == typeof A && S.update(Math.abs(A), s);
                            var M = null;
                            try {
                                M = S.getResult();
                            } catch (t) {
                            ...
                            var x = ce(A, M, a.scale, a.autoMinMax);
                            t.pushToMain({
                                index: e,
            ...
            macd: function(t, e, r, n, o, i) {
                var a = i.target, u = t.verticalOhlcv, l = t.instances, c = t.lastIndexReplace, s = "".concat(r, "_").concat(n, "_").concat(o).concat(a === Se ? "" : "_".concat(a));
                // Initialization on the first index.
                if (0 === e) {
                    ...
                    var v = f.filter((function(t) {
                        return "macd" === t.key;
                    })).length, b = v > 1 ? "macd_".concat(r, "_").concat(n, "_").concat(o) : "macd", d = a === Se ? "".concat(b, "_diff") : "".concat(b, "_diff_").concat(a), m = a === Se ? "".concat(b, "_dea") : "".concat(b, "_dea_").concat(a), g = a === Se ? "".concat(b, "_histogram") : "".concat(b, "_histogram_").concat(a);
                    // Choose a display prefix based on the number of indicators.
                        ...
                        settings: {}
                    }), l.macd.settings[s] = new qt(new Dt(r), new Dt(n), new Dt(o)), Object.assign(u, ge(ge(ge({}, d, we(y)), m, we(y)), g, we(y))), 
                    p.push(d, m, g);
                }
                var w = l.macd, O = w.numberOfIndicators, S = w.settings, j = O > 1 ? "macd_".concat(r, "_").concat(n, "_").concat(o) : "macd", _ = a === Se ? "".concat(j, "_diff") : "".concat(j, "_diff_").concat(a), P = a === Se ? "".concat(j, "_dea") : "".concat(j, "_dea_").concat(a), E = a === Se ? "".concat(j, "_histogram") : "".concat(j, "_histogram_").concat(a), A = S[s], M = u[a][e];
                A.update(M, c);
                var x = null;
                try {
                    x = A.getResult();
            ...
            donchianChannels: function(t, e, r, n, o) {
                ...
                var _ = h.donchian_channel.numberOfIndicators > 1 ? "donchian_channel_".concat(s) : "donchian_channel", P = h.donchian_channel.settings[s], E = P.maxDeque, A = P.minDeque, M = e - n, x = M + 1, k = x - r;
                ...
                for (var R = f.high, D = f.low; E.length && E[0] < k; ) E.shift();
                for (;E.length && R[E[E.length - 1]] <= R[M]; ) E.pop();
                // **Update the minimum deque:**
                for (E.push(M); A.length && A[0] < k; ) A.shift();
                for (;A.length && D[A[A.length - 1]] >= D[M]; ) A.pop();
                A.push(M);
                // Retrieve computed values with safety checks.
                var V = E.length ? R[E[0]] : null, B = A.length ? D[A[0]] : null, N = "number" == typeof V && "number" == typeof B ? (V + B) / 2 : null;
            ...
            bollingerBands: function(t, e, r, n, o) {
                ...
                if (0 === e) {
                    var _ = t.priceBased, P = t.inputParams, E = t.nullArray, A = t.verticalOhlcv;
                    if (!(v in A)) throw new Error('bollingerBands could not find target "'.concat(v, '"'));
                    ...
                    try {
                        for (T.s(); !(k = T.n()).done; ) {
                            var I = k.value;
                            if (!(I in A) || !_.includes(I)) throw new Error('Invalid range item value "'.concat(I, '" property for bollingerBands. Only price based key names are accepted:\n').concat(JSON.stringify(_)));
            ...
            candleVectors: function(t, e, r, n) {
                ...
                if (0 === e) {
                    for (var s = t.nullArray, f = [ [ "close", "open" ], [ "close", "high" ], [ "close", "low" ], [ "open", "high" ], [ "open", "low" ], [ "high", "low" ] ], h = [ [ "open", "open" ], [ "high", "high" ], [ "low", "low" ], [ "close", "close" ] ].concat(f), y = [], p = {}, v = 0; v < o; v++) {
                        ...
                        try {
                            for (d.s(); !(b = d.n()).done; ) {
                                var m = Ke(b.value, 2), g = m[0], w = m[1];
                                y.push("candle_change_".concat(v + 1, "_").concat(g, "_").concat(w)), p["candle_change_".concat(v + 1, "_").concat(g, "_").concat(w)] = Fe(s), 
                    ...
                    for (var O = [], S = {}, j = 0, _ = f; j < _.length; j++) {
                        var P = Ke(_[j], 2), E = P[0], A = P[1];
                        O.push("candle_body_".concat(E, "_").concat(A)), S["candle_body_".concat(E, "_").concat(A)] = Fe(s), 
                        a && t.autoMinMaxKeys.push("candle_body_".concat(E, "_").concat(A));
                    }
                    var M = [].concat(O, y);
                    Object.assign(u, ze(ze({}, S), p)), Object.assign(l, {
                        candleVectors: {
                            bodyVectors: f,
                            lookBackVectors: h,
                            keyNames: M,
                            arrayChunk: ze({}, Object.fromEntries(M.map((function(t) {
                                return [ t, [] ];
                            }))))
                        }
                    }), i > 0 && t.lag(M, i);
                ...
                for (var x = l.candleVectors, k = x.bodyVectors, T = x.lookBackVectors, I = x.arrayChunk, C = 0; C < k.length; C++) {
                    var R = Ke(k[C], 2), D = R[0], V = R[1], B = u[D][e], N = u[V][e], L = "candle_body_".concat(D, "_").concat(V), H = Ye(B, N), U = se(I, L, r, H, c);
                    t.pushToMain({
                        index: e,
                        key: L,
                        value: U
                ...
                for (var q = 0; q < o; q++) {
                    ...
                    try {
                        for ($.s(); !(z = $.n()).done; ) {
                            var F = Ke(z.value, 2), K = F[0], G = F[1], J = u[K][e], W = u[G][e - (q + 1)], Y = "candle_change_".concat(q + 1, "_").concat(K, "_").concat(G);
                            if (void 0 !== W) {
                                var Q = Ye(J, W), X = se(I, Y, r, Q, c);
                                t.pushToMain({
                                    index: e,
                                    key: Y,
                                    value: X
 ...
 // Optionally: throw an error if type is not recognized
            ...
            if (0 === n) {
                ...
                !function(t) {
                    ...
                    e.verticalOhlcv[t] = wr(e.nullArray);
                }));
                ...
                function(t, e) {
                    for (var r = 0, n = Object.keys(e.inputTypes); r < n.length; r++) {
                        ...
                        if (0 === e.precisionMultiplier && !0 === e.precision) {
                            var a = Or(String(i).split("."), 2)[1], u = void 0 === a ? "" : a, l = Math.max(4, u.length);
            ...
            for (var s = function(t) {
                ...
                var h = t[f], y = h.open, p = h.high, v = h.low, b = h.close, d = gr(h, dr), m = e.precisionMultiplier, g = Pr(y, e.inputTypes.open, m), w = Pr(p, e.inputTypes.high, m), O = Pr(v, e.inputTypes.low, m), S = Pr(b, e.inputTypes.close, m);
                ...
                //sets volume to 0
                    ...
                    var j = h.volume, _ = Er(j, e.inputTypes.volume);
                    e.pushToMain({
                        index: f,
                        key: "volume",
                        value: _
                ...
                try {
                    for (x.s(); !(M = x.n()).done; ) {
                        ...
                        [ "crossPairs", "lag" ].includes(T) || I.apply(void 0, [ e, f ].concat(wr(C)));
                    }
            ...
            for (var n = Mr(t, r), o = Mr(e, r), i = t.length, a = [], u = 0, l = 0, c = 0, s = 0, f = 0, h = 0, y = -1, p = 0; p < i; p++) {
 ...
 */ (t, "string");
        ...
        var Br = [ .001, .002, .0025, .005, .01, .02, .025, .05, .1, .2, .25, .5, 1, 2, 2.5, 5, 10 ], Nr =  function() {
            return t = function t(e) {
                ...
                value: function() {
                    ...
                    for (var e = this.precisionMultiplier, r = this.precision, n = this.invalidValueIndex, o = this.len, i = this.verticalOhlcv, a = this.priceBased, u = {}, l = n >= 0 && t, c = o - (n + 1), s = 0, f = Object.entries(i); s < f.length; s++) {
                        var h = Ir(f[s], 2), y = h[0], p = h[1], v = l ? p.slice(-c) : p;
                ...
                value: function(t) {
                    ...
                    this.len > this.lastComputedIndex && !t && Ar(this.input, this, 0), t && "object" === Tr(t)) {
                        var e;
                        ...
                        // Add new item
                        this.len++, this.input.push(t), Ar(this.input, this, this.len)) : (
                        // Modify the last item
                        this.input[n] = t, Ar(this.input, this, n));
                    }
                    return this;
                }
            }, {
                key: "crossPairs",
                value: function(t) {
                    return i(this), this.crossPairsList = [].concat(kr(this.crossPairsList), kr(t)), 
                ...
                value: function(t) {
                    ...
                    if ("number" == typeof n && !Br.includes(n)) throw new Error('"scale" value in relativeVolume must be any of the following numbers: '.concat(Br.join(", ")));
                ...
                value: function() {
                    ...
                    if ("object" !== Tr(n)) throw new Error('"options" must be an object in macd. eg: {target}');
                ...
                value: function() {
                    ...
                    if (i(this), !r || "object" !== Tr(r)) throw new Error('"options" must be an object in bollingerBands. eg: {target, height, range}');
                    ...
                    if ("number" == typeof f && !Br.includes(f)) throw new Error('"scale" value in bollingerBands must be any of the following numbers: '.concat(Br.join(", ")));
                    return this.inputParams.push({
                        key: "bollingerBands",
                        params: [ t, e, {
                            target: o,
                ...
                value: function(t) {
                    ...
                    if ("number" == typeof n && !Br.includes(n)) throw new Error('"scale" value in rsi must be any of the following numbers: '.concat(Br.join(", ")));
                ...
                value: function() {
                    ...
                    if ("number" == typeof c && !Br.includes(c)) throw new Error('"scale" value in donchianChannels must be any of the following numbers: '.concat(Br.join(", ")));
                    return this.inputParams.push({
                        key: "donchianChannels",
                        params: [ t, e, {
                            height: o,
                ...
                value: function() {
                    ...
                    if ("number" == typeof l && !Br.includes(l)) throw new Error('"scale" value in candleVectors must be any of the following numbers: '.concat(Br.join(", ")));
                ...
                value: function() {
                    ...
                    if ("number" == typeof o && !Br.includes(o)) throw new Error('"scale" value in volumeOscillator must be any of the following numbers: '.concat(Br.join(", ")));
                    return this.inputParams.push({
                        key: "volumeOscillator",
                        params: [ t, e, {
                            scale: o
            ...
            } ], e && Dr(t.prototype, e), r && Dr(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
            var t, e, r;
        }();
