 ...
 */
        ...
        var Dt =  function(t) {
            function e(t) {
                var r;
                return Pt(this, e), Rt(r = Mt(this, e, [ t ]), "interval", void 0), Rt(r, "pricesCounter", 0), 
                Rt(r, "weightFactor", void 0), r.interval = t, r.weightFactor = 2 / (r.interval + 1), 
                r;
            }
            return Tt(e, t), Et(e, [ {
                key: "update",
        ...
        var rr = function(t, e) {
            ...
            if (0 === e) {
                ...
                if ("object" !== er(u)) return;
                var l, c = u.map((function(t) {
                    return t.params;
                })), s = Xe(c);
                try {
                    for (s.s(); !(l = s.n()).done; ) {
                        var f, h = Qe(l.value, 2), y = h[0], p = h[1], v = Xe(y);
                        try {
                            for (v.s(); !(f = v.n()).done; ) {
                                var b = f.value;
            ...
            var m, g = Xe(r.lag.lagParams);
            try {
                for (g.s(); !(m = g.n()).done; ) {
                    var w, O = Qe(m.value, 2), S = O[0], _ = O[1], j = Xe(S);
                    try {
                        for (j.s(); !(w = j.n()).done; ) {
                            var P = w.value, A = n[P];
                            // Initialize lagged arrays only on the first index
                            if (0 === e) for (var E = 1; E <= _; E++) {
                                n["".concat(P, "_lag_").concat(E)] = Ye(o);
                            }
        ...
        var cr = function(t, e) {
            ...
            return t = function t() {
                ...
                value: function(t) {
                    ...
                    null === e || null === n || function(t, e) {
                        return t === e;
                    }(e, n) ? i = .5 : cr(e, n) ? i = this.areHighAndLowUndefined ? 1 : [ o, n, this.prevLow, this.prevSlow ].every((function(t) {
                        return null !== t;
                    })) && sr(o, n) && cr(this.prevLow, this.prevSlow) ? 0 : 1 : sr(e, n) && (i = this.areHighAndLowUndefined ? 0 : [ r, n, this.prevHigh, this.prevSlow ].every((function(t) {
                        return null !== t;
                    })) && cr(r, n) && sr(this.prevHigh, this.prevSlow) ? 1 : 0), .5 === i ? this.interval = 0 : 1 === i ? this.prevState <= .5 ? this.interval = 1 : this.interval++ : 0 === i && (this.prevState >= .5 ? this.interval = -1 : this.interval--), 
            ...
            } ]) && ur(t.prototype, e), r && ur(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
            var t, e, r;
        }(), hr = function(t, e) {
        ...
        var mr = [ "open", "high", "low", "close" ];
        function gr(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = _r(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        var Pr = {
            dateTime: function(t, e) {
                ...
                if (0 === e) {
                    ...
                    Object.assign(r, {
                        ...
                        day_of_the_week: yr(o),
                        day_of_the_month: yr(o),
                        week_of_the_month: yr(o),
                        hour: yr(o),
                        month: yr(o),
                        year: yr(o),
                        session_daily_index: yr(o),
                        session_intraday_index: yr(o)
                    });
                }
                var a = n.date[e], u = vr(a), l = u.day_of_the_week, c = u.day_of_the_month, s = u.week_of_the_month, f = u.month, h = u.year, y = u.hour, p = a.slice(0, 10);
            ...
            macd: function(t, e, r, n, o, i) {
                ...
                if (0 === e) {
                    ...
                    var v = f.filter((function(t) {
                        return "macd" === t.key;
                    })).length, b = v > 1 ? "macd_".concat(r, "_").concat(n, "_").concat(o) : "macd", d = a === Oe ? "".concat(b, "_diff") : "".concat(b, "_diff_").concat(a), m = a === Oe ? "".concat(b, "_dea") : "".concat(b, "_dea_").concat(a), g = a === Oe ? "".concat(b, "_histogram") : "".concat(b, "_histogram_").concat(a);
                    // Choose a display prefix based on the number of indicators.
                        ...
                        settings: {}
                    }), l.macd.settings[s] = new zt(new Dt(r), new Dt(n), new Dt(o)), Object.assign(u, me(me(me({}, d, ge(y)), m, ge(y)), g, ge(y))), 
                    p.push(d, m, g);
                }
            ...
            donchianChannels: function(t, e, r, n, o) {
                ...
                for (var C = f.high, D = f.low; A.length && A[0] < k; ) A.shift();
                for (;A.length && C[A[A.length - 1]] <= C[M]; ) A.pop();
                ...
                var V = A.length ? C[A[0]] : null, B = E.length ? D[E[0]] : null, N = "number" == typeof V && "number" == typeof B ? (V + B) / 2 : null;
            ...
            bollingerBands: function(t, e, r, n, o) {
                var i, a, u, l, c, s, f, h = o.height, y = o.range, p = void 0 === y ? [] : y, v = o.target, b = o.scale, d = o.lag, m = o.autoMinMax, g = t.verticalOhlcv, w = t.instances, O = t.lastIndexReplace, S = "close" === v ? "" : "_".concat(v), _ = "".concat(r, "_").concat(n).concat(S);
                ...
                if (0 === e) {
                    ...
                    var R = Object.fromEntries(x.map((function(t) {
                        return [ t, Ce(A) ];
                    })));
                    Object.assign(E, function(t) {
                        ...
                        return t;
                    }({}, R)), d > 0 && t.lag(x, d), j.push("".concat(f, "_upper"), "".concat(f, "_middle"), "".concat(f, "_lower"));
                }
                ...
                var C = f, D = w.bollinger_bands.settings[_], V = g[v][e];
            ...
            candleVectors: function(t, e, r, n) {
                var o = n.stdDev, i = n.patternSize, a = n.lag, u = n.scale, l = n.autoMinMax, c = t.verticalOhlcv, s = t.instances, f = t.lastIndexReplace, h = function(t, e) {
                    return ce(t, e, u, l);
                };
                if (0 === e) {
                    for (var y = t.nullArray, p = [ [ "close", "open" ], [ "close", "high" ], [ "close", "low" ], [ "open", "high" ], [ "open", "low" ], [ "high", "low" ] ], v = [ [ "open", "open" ], [ "high", "high" ], [ "low", "low" ], [ "close", "close" ] ].concat(p), b = [], d = {}, m = 0; m < i; m++) {
                        var g, w = Ke(v);
                        try {
                            for (w.s(); !(g = w.n()).done; ) {
                                var O = Fe(g.value, 2), S = O[0], _ = O[1];
                                b.push("candle_change_".concat(m + 1, "_").concat(S, "_").concat(_)), d["candle_change_".concat(m + 1, "_").concat(S, "_").concat(_)] = $e(y), 
                                l && t.autoMinMaxKeys.push("candle_change_".concat(m + 1, "_").concat(S, "_").concat(_));
                            }
                        } catch (t) {
                            w.e(t);
                        } finally {
                    ...
                    for (var j = [], P = {}, A = 0, E = p; A < E.length; A++) {
                        var M = Fe(E[A], 2), x = M[0], k = M[1];
                        j.push("candle_body_".concat(x, "_").concat(k)), P["candle_body_".concat(x, "_").concat(k)] = $e(y), 
                        l && t.autoMinMaxKeys.push("candle_body_".concat(x, "_").concat(k));
                    }
                    var T = [].concat(j, b);
                    Object.assign(c, ze(ze({}, P), d)), Object.assign(s, {
                        candleVectors: {
                            bodyVectors: p,
                            lookBackVectors: v,
                            keyNames: T,
                            bodyInstance: new _t(r, o)
                        }
                    }), a > 0 && t.lag(T, a);
                }
                if (0 === e) return !0;
                var I = s.candleVectors, R = I.bodyVectors, C = I.lookBackVectors, D = I.bodyInstance, V = null, B = c.open[e], N = c.close[e], L = We(N, B);
                // Update instances with current absolute values
                D.update(Math.abs(L), f);
                try {
                    V = D.getResult();
                } catch (t) {
                ...
                for (var H = 0; H < R.length; H++) {
                    var U = Fe(R[H], 2), z = U[0], q = U[1], $ = c[z][e], F = c[q][e];
                    t.pushToMain({
                        index: e,
                        key: "candle_body_".concat(z, "_").concat(q),
                        value: h(We($, F), V)
                    });
                }
                for (var K = 0; K < i; K++) {
                    ...
                    try {
                        for (J.s(); !(G = J.n()).done; ) {
                            var W = Fe(G.value, 2), Y = W[0], Q = W[1], X = c[Y][e], Z = c[Q][e - (K + 1)];
                            t.pushToMain({
                                index: e,
                                key: "candle_change_".concat(K + 1, "_").concat(Y, "_").concat(Q),
                                value: void 0 === Z ? null : h(We(X, Z), V)
                            });
                        }
                    } catch (t) {
                        J.e(t);
 ...
 // Optionally: throw an error if type is not recognized
            ...
            if (0 === n) {
                ...
                !function(t) {
                    ...
                    e.verticalOhlcv[t] = Or(e.nullArray);
                }));
                ...
                function(t, e) {
                    for (var r = 0, n = Object.keys(e.inputTypes); r < n.length; r++) {
                        ...
                        if (0 === e.precisionMultiplier && !0 === e.precision) {
                            var a = Sr(String(i).split("."), 2)[1], u = void 0 === a ? "" : a, l = Math.max(4, u.length);
            ...
            for (var s = function(t) {
                ...
                var h = t[f], y = h.open, p = h.high, v = h.low, b = h.close, d = wr(h, mr), m = e.precisionMultiplier, g = Ar(y, e.inputTypes.open, m), w = Ar(p, e.inputTypes.high, m), O = Ar(v, e.inputTypes.low, m), S = Ar(b, e.inputTypes.close, m);
                ...
                //sets volume to 0
                    ...
                    var _ = h.volume, j = Er(_, e.inputTypes.volume);
                    e.pushToMain({
                        index: f,
                        key: "volume",
                        value: j
                ...
                try {
                    for (x.s(); !(M = x.n()).done; ) {
                        var k = M.value, T = k.key, I = k.fn, R = k.args;
                        [ "crossPairs", "lag" ].includes(T) || I.apply(void 0, [ e, f ].concat(Or(R)));
                    }
                ...
                rr(e, f), hr(e, f), e.lastComputedIndex++;
            }
        }, xr = function(t, e) {
            ...
            for (var n = xr(t, r), o = xr(e, r), i = t.length, a = [], u = 0, l = 0, c = 0, s = 0, f = 0, h = 0, y = -1, p = 0; p < i; p++) {
 ...
 */ (t, "string");
        ...
        var Nr = [ .001, .002, .0025, .005, .01, .02, .025, .05, .1, .2, .25, .5, 1, 2, 2.5, 5, 10 ], Lr =  function() {
            return t = function t(e) {
                ...
                value: function(t) {
                    ...
                    this.len > this.lastComputedIndex && !t && Mr(this.input, this, 0), t && "object" === Ir(t)) {
                        var e;
                        ...
                        // Add new item
                        this.len++, this.input.push(t), Mr(this.input, this, this.len)) : (
                        // Modify the last item
                        this.input[n] = t, Mr(this.input, this, n));
                    }
                    return this;
                }
            }, {
                key: "crossPairs",
                value: function(t) {
                    return i(this), this.crossPairsList = [].concat(Tr(this.crossPairsList), Tr(t)), 
                ...
                value: function(t) {
                    ...
                    if ("number" == typeof n && !Nr.includes(n)) throw new Error('"scale" value in relativeVolume must be any of the following numbers: '.concat(Nr.join(", ")));
                ...
                value: function() {
                    ...
                    if ("object" !== Ir(n)) throw new Error('"options" must be an object in macd. eg: {target}');
                ...
                value: function() {
                    ...
                    if (i(this), !r || "object" !== Ir(r)) throw new Error('"options" must be an object in bollingerBands. eg: {target, height, range}');
                    ...
                    if ("number" == typeof f && !Nr.includes(f)) throw new Error('"scale" value in bollingerBands must be any of the following numbers: '.concat(Nr.join(", ")));
                    return this.inputParams.push({
                        key: "bollingerBands",
                        params: [ t, e, {
                            target: o,
                ...
                value: function(t) {
                    ...
                    if ("number" == typeof n && !Nr.includes(n)) throw new Error('"scale" value in rsi must be any of the following numbers: '.concat(Nr.join(", ")));
                ...
                value: function() {
                    ...
                    if ("number" == typeof c && !Nr.includes(c)) throw new Error('"scale" value in donchianChannels must be any of the following numbers: '.concat(Nr.join(", ")));
                    return this.inputParams.push({
                        key: "donchianChannels",
                        params: [ t, e, {
                            height: o,
                ...
                value: function() {
                    ...
                    var r = e.stdDev, n = void 0 === r ? 1 : r, o = e.lag, a = void 0 === o ? 0 : o, u = e.scale, l = void 0 === u ? .05 : u, c = e.patternSize, s = void 0 === c ? 1 : c, f = e.autoMinMax, h = void 0 !== f && f;
                    if ("number" != typeof n || n <= 0) throw new Error('"stdDev" must be a positive number greater than 0 in candleVectors.');
                    if ("number" == typeof l && !Nr.includes(l)) throw new Error('"scale" value in candleVectors must be any of the following numbers: '.concat(Nr.join(", ")));
                    if ("number" != typeof s || !Number.isInteger(s) || s < 1) throw new Error('"patternSize" value in candleVectors must be an integer greater than 0.');
                ...
                value: function() {
                    ...
                    if ("number" == typeof o && !Nr.includes(o)) throw new Error('"scale" value in volumeOscillator must be any of the following numbers: '.concat(Nr.join(", ")));
                    return this.inputParams.push({
                        key: "volumeOscillator",
                        params: [ t, e, {
                            scale: o
            ...
            } ], e && Vr(t.prototype, e), r && Vr(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
            var t, e, r;
        }();
