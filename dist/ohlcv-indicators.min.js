 ...
 */
        ...
        var Br = {
            ...
            atr: function(t, e, r, n) {
                var o = n.lag, i = t.verticalOhlcv, a = t.instances, u = "atr_".concat(r);
                if (0 === e) {
                    var l = t.instances, c = t.verticalOhlcv, s = t.arrayTypes, f = t.len, y = t.priceBased;
                    l[u] = new Yt(r, jt), c[u] = new Float64Array(f).fill(NaN), y.add(u), o > 0 && t.lag([ u ], o), 
                    s[u] = "Float64Array";
                }
                // Retrieve the current price value.
                                var p = {
