 ...
 */
        ...
        function U(t, e, r) {
            ...
            }(t, $() ? Reflect.construct(e, r || [], q(t).constructor) : e.apply(t, r));
        }
        function $() {
            try {
                var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], (function() {})));
        ...
        var Gt =  function() {
            return $t((function t(e, r, n) {
                Vt(this, t), qt(this, "short", void 0), qt(this, "long", void 0), qt(this, "signal", void 0), 
                qt(this, "prices", []), qt(this, "result", void 0), this.short = e, this.long = r, 
                this.signal = n;
            }), [ {
                key: "getResult",
                value: function() {
        ...
        var ue = {
            ...
            if (0 === e) {
                ...
                }, u[f] = new Float64Array(y).fill(NaN), l.push(f), a > 0 && t.lag([ f ], a), h[f] = "Float64Array";
            }
        ...
        var Ae = {
            ...
            var e = [ "Date -> object", "Milliseconds Timestamp -> integer", "Seconds Timestamp -> integer", "UTC Time Format (ISO 8601) -> string", "Including a Timezone Offset (ISO 8601) -> string", "Local Time Format (ISO 8601) -> string", "YYYY/MM/DD or YYYY-MM-DD -> string" ], r = function() {
                throw new Error('Invalid "'.concat(Te(t), '" date value passed in selectDateFormatter. Supported formats: \n-').concat(e.join("\n- ")));
            };
        ...
        var Me = [ "open", "high", "low", "close" ], Ie = function(t, e) {
        ...
        function Re(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = Ce(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        var Be = function(t, e) {
            ...
            if (0 === e) {
                ...
                if ("object" !== Le(u)) return;
                var c, l = u.map((function(t) {
                    return t.params;
                })), s = Re(l);
                try {
                    for (s.s(); !(c = s.n()).done; ) {
                        var f, y = De(c.value, 2), h = y[0], p = y[1], v = Re(h);
                        try {
                            for (v.s(); !(f = v.n()).done; ) {
                                var m = f.value;
                                if (a.includes(m)) for (var d = 1; d <= p; d++) a.push("".concat(m, "_lag_").concat(d));
                            }
                        } catch (t) {
                            v.e(t);
                        } finally {
            ...
            try {
                for (g.s(); !(b = g.n()).done; ) {
                    var w, O = De(b.value, 2), S = O[0], j = O[1], P = Re(S);
                    try {
                        for (P.s(); !(w = P.n()).done; ) {
                            var _ = w.value, N = n[_];
        ...
        var ze = function(t, e) {
            ...
            return t = function t() {
                ...
                value: function(t, e) {
                    ...
                    Number.isNaN(r) || Number.isNaN(o) || function(t, e) {
                        return t === e;
                    }(r, o) ? a = .5 : ze(r, o) ? a = this.areHighAndLowUndefined ? 1 : [ i, o, this.prevLow, this.prevSlow ].every((function(t) {
                        return !Number.isNaN(t);
                    })) && Ge(i, o) && ze(this.prevLow, this.prevSlow) ? 0 : 1 : Ge(r, o) && (a = this.areHighAndLowUndefined ? 0 : [ n, o, this.prevHigh, this.prevSlow ].every((function(t) {
                        return !Number.isNaN(t);
                    })) && ze(n, o) && Ge(this.prevHigh, this.prevSlow) ? 1 : 0), .5 === a ? this.interval = 0 : 1 === a ? this.prevState <= .5 ? this.interval = 1 : this.interval++ : 0 === a && (this.prevState >= .5 ? this.interval = -1 : this.interval--), 
            ...
            } ]) && $e(t.prototype, e), r && $e(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
            var t, e, r;
        }(), Ke = function(t, e) {
            ...
            var u, c = He(n.crossPairs.crossPairsList);
            try {
                for (c.s(); !(u = c.n()).done; ) {
                    ...
                    if (null != s && null != f) {
                        ...
                        if (0 === e) {
                            ...
                            n[y] = new Ye, r[y] = new Int32Array(o).fill(NaN), i[y] = "Int32Array";
                        }
        ...
        function tr(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = rr(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        function ir(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = ur(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        var lr = {
            dateTime: function(t, e, r) {
                ...
                var y = i.date[e], h = We(y), p = h.day_of_the_week, v = h.day_of_the_month, m = h.week_of_the_month, d = h.month, b = h.year, g = h.hour, w = y;
            ...
            donchianChannels: function(t, e, r, n, o) {
                ...
                if (0 === e) {
                    ...
                    try {
                        for (g.s(); !(b = g.n()).done; ) {
                            var w = b.value;
                            if (!(w in l) || !h.includes(w)) throw new Error('Invalid range item value "'.concat(w, '" property for donchianChannels. Only price based key names are accepted:\n').concat(JSON.stringify(h)));
                    ...
                    Object.assign(l, function(t) {
                        ...
                        return t;
                    }({}, O)), u > 0 && t.lag(d, u), h.push("".concat(m, "_upper"), "".concat(m, "_basis"), "".concat(m, "_lower")), 
                ...
                try {
                    for (V.s(); !(H = V.n()).done; ) {
                        var U = H.value, $ = NaN, q = l[U][e];
                        Number.isNaN(q) || Number.isNaN(C) || Number.isNaN(F) || ($ = (q - F) / (C - F)), 
                        t.pushToMain({
                            index: e,
            ...
            bollingerBands: function(t, e, r, n, o) {
                ...
                if (0 === e) {
                    ...
                    try {
                        for (E.s(); !(A = E.n()).done; ) {
                            var k = A.value;
                            if (!(k in j) || !O.includes(k)) throw new Error('Invalid range item value "'.concat(k, '" property for bollingerBands. Only price based key names are accepted:\n').concat(JSON.stringify(O)));
                    ...
                    Object.assign(j, function(t) {
                        ...
                        return t;
                    }({}, x)), m > 0 && t.lag(T, m), O.push("".concat(f, "_upper"), "".concat(f, "_middle"), "".concat(f, "_lower"));
                ...
                try {
                    for ($.s(); !(U = $.n()).done; ) {
                        var q = U.value, z = NaN, G = d[q][e];
                        Number.isNaN(G) || Number.isNaN(H) || Number.isNaN(L) || (z = (G - H) / (L - H)), 
                        t.pushToMain({
                            index: e,
                            key: "".concat(D, "_range_").concat(q),
                            value: z
                        });
                    }
                } catch (t) {
                ...
                if (0 === e) {
                    ...
                    try {
                        var d = function() {
                            ...
                            if (!p.includes(e)) throw new Error('Column "'.concat(e, '" is not priceBased and cannot be scaled.'));
                            ...
                            t.ScaledGroups[y].push(r)), u > 0) {
                                if (i) {
                                    ...
                                    (o = t.ScaledGroups[y]).push.apply(o, Xe(a));
                                }
                                t.lag([ r ], u);
                            }
                        };
                ...
                // scale values once enough data
                    ...
                    var T = function() {
                        ...
                        if (_) {
                            var g = b[i ? y : p];
                            if ("minmax" === o) {
                                var w = Math.min.apply(Math, Xe(g)), O = Math.max.apply(Math, Xe(g));
                                r = v, n = w, u = O, l = er(a, 2), s = l[0], h = l[1], d = (Math.min(Math.max(r, n), u) - n) / (u - n) * (h - s) + s;
                            } else {
            ...
            var r = e.len, o = e.inputParams, i = e.priceBased, a = e.precisionMultiplier, u = e.arrayTypes;
            !function(t) {
            ...
            for (var c = 0, l = Object.keys(e.inputTypes); c < l.length; c++) {
                var s = l[c];
                e.verticalOhlcv[s] = Ie(u[s], r);
            }
            // Process each row in the input
                        for (var f = 0; f < r; f++) {
                for (var y = t[f], h = 0, p = Object.entries(e.inputTypes); h < p.length; h++) {
                    var v = ar(p[h], 2), m = v[0], d = v[1], b = y[m];
                    if (_e.hasOwnProperty(d)) {
                        var g = _e[d](b);
                        a > 1 && i.includes(m) && (g *= a), e.pushToMain({
                            index: f,
                            key: m,
                            value: g
                        });
                    } else Ae.hasOwnProperty(d) ? e.pushToMain({
                        index: f,
                        key: m,
                        value: Ae[d](b)
                    }) : e.pushToMain({
                ...
                try {
                    for (O.s(); !(w = O.n()).done; ) {
                        var S = w.value, j = S.key, P = S.params;
                        "lag" !== j && "crossPairs" !== j && 
                        // resolve fn on-demand, no per-item object allocation here
                        lr[j].apply(lr, [ e, f ].concat(or(P)));
                    }
            ...
            for (var n = fr(t, r), o = fr(e, r), i = t.length, a = [], u = 0, c = 0, l = 0, s = 0, f = 0, y = 0, h = -1, p = 0; p < i; p++) {
        ...
        var mr = function(t, e) {
            ...
            try {
                for (a.s(); !(o = a.n()).done; ) {
                    var u = o.value, c = hr(String(u).split("."), 2)[1], l = void 0 === c ? "" : c, s = Math.max(4, l.length), f = s > 1 ? Math.pow(10, s - 1) : 1;
                    f > i && (i = f);
                }
            } catch (t) {
                a.e(t);
 ...
 */ (t, "string");
        ...
        var Pr =  function() {
            return t = function t(e) {
                ...
                c(l, "precision", "constructor"), this.firstRow = n[0], this.inputCols = Object.keys(this.firstRow);
                var y = function(t) {
                    for (var e = {}, r = {}, n = 0, o = Object.entries(t); n < o.length; n++) {
                        var i = ke(o[n], 2), a = i[0], u = i[1];
                        if ("date" === a) e[a] = Ee(u), r[a] = "Array"; else if ("volume" === a) e[a] = Ne(u, !0), 
                        r[a] = "Int32Array"; else if (Me.includes(a)) e[a] = Ne(u, !0), r[a] = "Float64Array"; else {
                            var c = Ne(u, !1);
                ...
                this.input = n, this.priceBased = [ "open", "high", "low", "close" ], this.len = n.length, 
                this.instances = {}, this.crossPairsList = [], this.verticalOhlcv = {}, this.studies = {}, 
                this.utilities = {
                    correlation: yr
                }, this.invalidValueIndex = -1, this.precision = l, this.precisionMultiplier = mr(this, this.firstRow), 
                ...
                value: function() {
                    ...
                    for (var e = this.precisionMultiplier, r = this.precision, n = this.invalidValueIndex, o = this.len, i = this.verticalOhlcv, a = this.priceBased, u = {}, c = n >= 0 && t, l = o - (n + 1), s = 0, f = Object.entries(i); s < f.length; s++) {
                        var y = gr(f[s], 2), h = y[0], p = y[1], v = c ? p.slice(-l) : p;
                        ...
                        r && a.includes(h) && (v = v.map((function(t) {
                ...
                value: function() {
                    ...
                    return function(t) {
                        ...
                        for (var u = e && i >= 0 ? i + 1 : 0, c = t[a[0]].length, l = new Array(c - u), s = u; s < c; s++) {
                            for (var f = {}, y = 0; y < a.length; y++) {
                                var h = a[y], p = t[h][s];
                                f[h] = r && o.includes(h) ? p / n : p;
                            }
                            l[s - u] = f;
                        }
                        return l;
                ...
                value: function() {
                    ...
                    return r ? function(t) {
                        for (var e = t.row, r = t.precisionMultiplier, n = t.priceBased, o = {}, i = 0, a = Object.entries(e); i < a.length; i++) {
                            var u = je(a[i], 2), c = u[0], l = u[1];
                            n.includes(c) && (l /= r), o[c] = l;
                        }
                        return o;
                    }({
                        row: i,
                ...
                value: function() {
                    ...
                    this.len > 0 && (sr(this.input, this), this.isComputed = !0)), this;
                }
            }, {
                key: "crossPairs",
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], e = "crossPairs";
                    return i(this), a(t, "arr", e), this.crossPairsList = [].concat(br(this.crossPairsList), br(t)), 
                ...
                value: function() {
                    ...
                    if (!this.inputCols.includes("volume")) throw new Error('If "relativeVolume" is called the input ohlcv must contain valid volume properties.');
                    i(this), l(t, {
                        min: 1,
                        max: this.len,
                        allowDecimals: !1
                ...
                value: function() {
                    ...
                    if (!this.inputCols.includes("volume")) throw new Error('If "volumeOscillator" is called the input ohlcv must contain valid volume properties.');
                    i(this), l(t, {
                        min: 1,
                        max: this.len,
                        allowDecimals: !1
            ...
            } ], e && Sr(t.prototype, e), r && Sr(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
            var t, e, r;
        }();
