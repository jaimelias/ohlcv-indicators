            ...
            return t = function t(e) {
                ...
                this.compute()), this.inputParams = [], this.pushToMain = function(t) {
                    ...
                    return function(t) {
                        ...
                        if (e.invalidValueIndex, null == o) for (var f in u) u[f] = {
                            min: 1 / 0,
                            max: -1 / 0
                        };
                        if (l[n][r] = o, "number" == typeof o && !n.includes("_x_")) {
                            var h = c.includes(n);
                            if (n.includes("_diff_") && h) u.hasOwnProperty(n) && u[n].min !== 1 / 0 && u[n].max !== -1 / 0 || (u[n] = {
                                min: -1,
                                max: 1
                            }); else if (n.startsWith("candle_") && h) u[n] = {
                                min: -1,
                                max: 1
                            }; else if (n.includes("_range_") && h) u[n] = {
                                min: 0,
                                max: 1
                            }; else if (n.startsWith("rsi_") && h) u[n] = {
                                min: 0,
                                max: 1
                            }; else {
                                var y = i && a.includes(n) ? o / s : o;
                                u.hasOwnProperty(n) || (u[n] = {
                                    min: 1 / 0,
                                    max: -1 / 0
                                }), y < u[n].min && (u[n].min = y), y > u[n].max && (u[n].max = y);
                            }
                        }
                        return !0;
                    }({
