 ...
 */
        ...
        var Br = {
            ...
            atr: function(t, e, r, n) {
                var o = n.lag, i = n.tp, a = n.sl, u = t.verticalOhlcv, l = t.instances, c = "atr_".concat(r);
                if (0 === e) {
                    var s = t.instances, f = t.verticalOhlcv, y = t.arrayTypes, p = t.len, h = t.priceBased;
                    s[c] = new Yt(r, jt);
                    var v = [ c ];
                    null !== i && v.push("".concat(c, "_tp")), null !== a && v.push("".concat(c, "_sl"));
                    for (var m = 0, d = v; m < d.length; m++) {
                        var b = d[m];
                        h.add(b), f[b] = new Float64Array(p).fill(NaN), y[b] = "Float64Array";
                    }
                    o > 0 && t.lag(v, o);
                }
                // Retrieve the current price value.
                ...
                return null !== i && t.pushToMain({
                    index: e,
                    key: "".concat(c, "_tp"),
                    value: Number.isNaN(O) ? NaN : g.close + O * i
                }), null !== a && t.pushToMain({
                    index: e,
                    key: "".concat(c, "_sl"),
                    value: Number.isNaN(O) ? NaN : g.close - O * a
                }), 
                // Always push the MA value (even if NaN).
                t.pushToMain({
                    index: e,
        ...
        var rn =  function() {
            return t = function t(e) {
                ...
                value: function() {
                    ...
                    var n = e.lag, o = void 0 === n ? 0 : n, i = e.tp, a = void 0 === i ? null : i, u = e.sl, c = void 0 === u ? null : u;
                    return p(o, {
                        min: 0,
                        max: this.len,
                        allowDecimals: !1
                    }, "options.lag", r), null !== a && p(a, {
                        min: .01,
                        max: 100,
                        allowDecimals: !0
                    }, "options.tp", r), null !== c && p(c, {
                        min: .01,
                        max: 100,
                        allowDecimals: !0
                    }, "options.tp", r), this.inputParams.push({
                        key: r,
                        params: [ t, {
                            lag: o,
                            tp: a,
