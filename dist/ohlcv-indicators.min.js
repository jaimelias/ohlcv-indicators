 ...
 */
        y.div = function(t) {
            ...
            var l, c, f, y, v, d = o.slice(), m = l = o.length, g = n.length, w = n.slice(0, l), // remainder
            O = w.length, S = t, // quotient
            j = S.c = [], _ = 0, P = u + (S.e = e.e - t.e) + 1;
 // precision of the result
                        // Add zeros to make remainder as long as divisor.
            for (S.s = i, i = P < 0 ? 0 : P, 
            // Create version of divisor with leading zero.
            d.unshift(0); O++ < l; ) w.push(0);
            do {
 ...
 */
        y.prec = function(t, e) {
            ...
            return b(new this.constructor(this), t, e);
        }, 
        /*
 ...
 */
        y.round = function(t, e) {
            ...
            return b(new this.constructor(this), t + this.e + 1, e);
        }, 
        /*
 ...
 */
        y.toExponential = function(t, e) {
            ...
            if (t !== p) {
                ...
                for (r = b(new r.constructor(r), ++t, e); r.c.length < t; ) r.c.push(0);
            }
            return d(r, !0, !!n);
        }, 
        /*
 ...
 */
        y.toFixed = function(t, e) {
            ...
            if (t !== p) {
                ...
                for (t = t + (r = b(new r.constructor(r), t + r.e + 1, e)).e + 1; r.c.length < t; ) r.c.push(0);
            }
            return d(r, !1, !!n);
        }, 
        /*
 ...
 */
        y[Symbol.for("nodejs.util.inspect.custom")] = y.toJSON = y.toString = function() {
            ...
            return d(t, t.e <= e.NE || t.e >= e.PE, !!t.c[0]);
        }, 
        /*
 * Return the value of this Big as a primitve number.
 */
        y.toNumber = function() {
            var t = Number(d(this, !0, !0));
 ...
 */
        y.toPrecision = function(t, e) {
            ...
            if (t !== p) {
                if (t !== ~~t || t < 1 || t > a) throw Error(c + "precision");
                for (r = b(new n(r), t, e); r.c.length < t; ) r.c.push(0);
            }
            return d(r, t <= r.e || r.e <= n.NE || r.e >= n.PE, !!o);
        }, 
        /*
 * Return a string representing the value of this Big.
 * Return exponential notation if this Big has a positive exponent equal to or greater than
 ...
 */
        y.valueOf = function() {
            ...
            return d(t, t.e <= e.NE || t.e >= e.PE, !0);
        };
        // Export
        (
        /*
 ...
 */
        ...
        function O(t, e, r) {
            ...
            }(t, j() ? Reflect.construct(e, r || [], P(t).constructor) : e.apply(t, r));
        }
        function S(t) {
        ...
        var F =  function(t) {
            function e(t) {
                var r;
                return D(this, e), q(r = N(this, e), "interval", void 0), r.interval = t, r;
            }
            return U(e, t), B(e, [ {
                key: "updates",
                value: function(t) {
            ...
            return wt((function t(e) {
                ...
                value: function(t) {
                    if (this.prices.push(t), this.prices.length > this.interval) {
                        this.prices.shift();
                        var e = bt(this.prices), r = function(t, e) {
                            var r = e || bt(t), n = bt(t.map((function(t) {
                                return t - r;
                            })).map((function(t) {
                                return t * t;
                            })));
        ...
        var de = {
            ...
            if (!r || "object" !== fe(r)) throw new Error('"options" must be an object in '.concat(t, ". eg: {target, height, range}"));
            ...
            if (null !== u && ("object" === fe(u) || "boolean" == typeof u && !0 === u)) {
                var c = u = !0 === u ? {} : u, s = c.stdDev, f = void 0 === s ? 2 : s, h = c.scale, y = void 0 === h ? .05 : h, p = c.targets, v = void 0 === p ? [ "close" ] : p, b = c.size, d = void 0 === b ? e : b, m = c.lag, g = void 0 === m ? 0 : m, w = c.autoMinMax, O = void 0 !== w && w;
                ...
                if ("number" != typeof d || !Number.isInteger(d) || d <= 0) throw new Error('"diff.size" must be an integer greater than or equal to size in '.concat(t, "."));
        ...
        function ke(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = Te(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        function Te(t, e) {
            if (t) {
                ...
                var r = {}.toString.call(t).slice(8, -1);
                return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r || "Set" === r ? Array.from(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? Ie(t, e) : void 0;
            }
        }
        function Ie(t, e) {
            (null == e || e > t.length) && (e = t.length);
        ...
        function Je(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = We(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        function tr(t, e) {
            var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = er(t)) || e && t && "number" == typeof t.length) {
                    r && (t = r);
                    var n = 0, o = function() {};
                    return {
                        s: o,
        ...
        var or = function(t, e) {
            ...
            if (0 === e) {
                ...
                if ("object" !== nr(u)) return;
                var l, c = u.map((function(t) {
                    return t.params;
                })), s = tr(c);
                try {
                    for (s.s(); !(l = s.n()).done; ) {
                        var f, h = Ze(l.value, 2), y = h[0], p = h[1], v = tr(y);
                        try {
                            for (v.s(); !(f = v.n()).done; ) {
                                var b = f.value;
                                if (a.includes(b)) for (var d = 1; d <= p; d++) a.push("".concat(b, "_lag_").concat(d));
                            }
                        } catch (t) {
                            v.e(t);
                        } finally {
            ...
            var m, g = tr(r.lag.lagParams);
            try {
                for (g.s(); !(m = g.n()).done; ) {
                    var w, O = Ze(m.value, 2), S = O[0], j = O[1], _ = tr(S);
                    try {
                        for (_.s(); !(w = _.n()).done; ) {
                            var P = w.value, A = n[P];
                            // Initialize lagged arrays only on the first index
                            if (0 === e) for (var E = 1; E <= j; E++) {
                                n["".concat(P, "_lag_").concat(E)] = Xe(o);
                            }
        ...
        function ar(t, e) {
            if (t) {
                ...
                var r = {}.toString.call(t).slice(8, -1);
                return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r || "Set" === r ? Array.from(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? ur(t, e) : void 0;
            }
        }
        function ur(t, e) {
            (null == e || e > t.length) && (e = t.length);
        ...
        var fr = function(t, e) {
            ...
            return t = function t() {
                ...
                value: function(t) {
                    ...
                    null === e || null === n || function(t, e) {
                        return t === e;
                    }(e, n) ? i = .5 : fr(e, n) ? i = this.areHighAndLowUndefined ? 1 : [ o, n, this.prevLow, this.prevSlow ].every((function(t) {
                        return null !== t;
                    })) && hr(o, n) && fr(this.prevLow, this.prevSlow) ? 0 : 1 : hr(e, n) && (i = this.areHighAndLowUndefined ? 0 : [ r, n, this.prevHigh, this.prevSlow ].every((function(t) {
                        return null !== t;
                    })) && fr(r, n) && hr(this.prevHigh, this.prevSlow) ? 1 : 0), .5 === i ? this.interval = 0 : 1 === i ? this.prevState <= .5 ? this.interval = 1 : this.interval++ : 0 === i && (this.prevState >= .5 ? this.interval = -1 : this.interval--), 
            ...
            } ]) && cr(t.prototype, e), r && cr(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
            var t, e, r;
        }(), pr = function(t, e) {
            ...
            var u, l = function(t, e) {
                var r = "undefined" != typeof Symbol && t[Symbol.iterator] || t["@@iterator"];
                if (!r) {
                    if (Array.isArray(t) || (r = ar(t)) || e && t && "number" == typeof t.length) {
                        r && (t = r);
                        var n = 0, o = function() {};
                        return {
                            s: o,
            ...
            try {
                for (l.s(); !(u = l.n()).done; ) {
                    ...
                    if (null != s && null != f) {
                        ...
                        var y = void 0, p = void 0, v = void 0, b = void 0, d = void 0;
                        "price" === s ? (p = n.close[e], v = n.high[e], b = n.low[e], d = n[f][e], o[h].update({
                            fast: p,
                            slow: d,
                            high: v,
                            low: b
                        })) : (y = n[s][e], d = n[f][e], o[h].update({
                            fast: y,
                            slow: d
                        })), t.pushToMain({
                            index: e,
        ...
        var Er = {
            dateTime: function(t, e) {
                ...
                if (0 === e) {
                    ...
                    Object.assign(r, {
                        ...
                        day_of_the_week: vr(o),
                        day_of_the_month: vr(o),
                        week_of_the_month: vr(o),
                        hour: vr(o),
                        month: vr(o),
                        year: vr(o),
                        session_daily_index: vr(o),
                        session_intraday_index: vr(o)
                    });
                }
            ...
            priceVariations: function(t, e) {
                0 === e && (t.priceBased = mr(new Set([].concat(mr(t.priceBased), [ "mid_price_open_close", "mid_price_high_low" ]))), 
                Object.assign(t.verticalOhlcv, {
                    mid_price_open_close: mr(t.nullArray),
                    mid_price_high_low: mr(t.nullArray)
                }));
            ...
            rsi: function(t, e, r, n) {
                ...
                null !== d && "number" == typeof d && o && (d = ne(d, o)), 
                ...
                null !== d && "number" == typeof d && c[y].update(d, s);
                try {
                    m = c[y].getResult();
                } catch (t) {
                    m = null;
            ...
            movingAverages: function(t, e, r, n, o) {
                ...
                if (0 === e) {
                    ...
                    if (l[h] = {
                        maInstance: new de[r](n),
                        arrayChunk: be({}, y, [])
                    }, u[h] = ye(p), null !== a) {
                        l[h].diffInstance = new jt(a.size, a.stdDev);
                        var v, b = [], d = he(a.targets);
                        try {
                            for (d.s(); !(v = d.n()).done; ) {
                                var m = v.value;
                                u["".concat(y, "_").concat(m)] = ye(p), a.autoMinMax && t.autoMinMaxKeys.push("".concat(y, "_").concat(m)), 
                                a.lag > 0 && b.push("".concat(y, "_").concat(m));
                            }
                        } catch (t) {
                            d.e(t);
                        } finally {
                        ...
                        a.lag > 0 && t.lag(b, a.lag);
                    }
                    c.push(h);
                }
                // Retrieve the current price value.
                                var g = u[i][e], w = l[h], O = w.maInstance, S = w.diffInstance, j = w.arrayChunk;
                ...
                if (t.pushToMain({
                    ...
                    var P, A = he(a.targets);
                    try {
                        for (A.s(); !(P = A.n()).done; ) {
                            var E = P.value, M = null, x = null;
                            // Compute diffValue only if we have a valid MA value.
                                                        null !== _ && "number" == typeof _ && (M = u[E][e] - _), 
                            // Update the diff indicator only if diffValue is a valid number.
                            null !== M && "number" == typeof M && (S.update(Math.abs(M), s), x = se(j, y, a.size, M, s));
                            var k = null;
                            try {
                                k = S.getResult();
                            } catch (t) {
                            ...
                            ce(M, k, a.scale, a.autoMinMax);
                            t.pushToMain({
                                index: e,
                                key: "".concat(y, "_").concat(E),
                                value: x
                            });
                        }
                    } catch (t) {
            ...
            macd: function(t, e, r, n, o, i) {
                var a = i.target, u = t.verticalOhlcv, l = t.instances, c = t.lastIndexReplace, s = "".concat(r, "_").concat(n, "_").concat(o).concat(a === je ? "" : "_".concat(a));
                // Initialization on the first index.
                if (0 === e) {
                    ...
                    var v = f.filter((function(t) {
                        return "macd" === t.key;
                    })).length, b = v > 1 ? "macd_".concat(r, "_").concat(n, "_").concat(o) : "macd", d = a === je ? "".concat(b, "_diff") : "".concat(b, "_diff_").concat(a), m = a === je ? "".concat(b, "_dea") : "".concat(b, "_dea_").concat(a), g = a === je ? "".concat(b, "_histogram") : "".concat(b, "_histogram_").concat(a);
                    // Choose a display prefix based on the number of indicators.
                        ...
                        settings: {}
                    }), l.macd.settings[s] = new zt(new Dt(r), new Dt(n), new Dt(o)), Object.assign(u, we(we(we({}, d, Oe(y)), m, Oe(y)), g, Oe(y))), 
                    p.push(d, m, g);
                }
                var w = l.macd, O = w.numberOfIndicators, S = w.settings, j = O > 1 ? "macd_".concat(r, "_").concat(n, "_").concat(o) : "macd", _ = a === je ? "".concat(j, "_diff") : "".concat(j, "_diff_").concat(a), P = a === je ? "".concat(j, "_dea") : "".concat(j, "_dea_").concat(a), A = a === je ? "".concat(j, "_histogram") : "".concat(j, "_histogram_").concat(a), E = S[s], M = u[a][e];
                E.update(M, c);
                var x = null;
                try {
                    x = E.getResult();
            ...
            donchianChannels: function(t, e, r, n, o) {
                ...
                if (0 === e) {
                    var p = t.inputParams, v = t.priceBased, b = t.nullArray, d = p.filter((function(t) {
                        return "donchianChannels" === t.key;
                    })).length, m = d > 1 ? "donchian_channel_".concat(s) : "donchian_channel", g = [ "".concat(m, "_upper"), "".concat(m, "_basis"), "".concat(m, "_lower") ];
                    ...
                    Object.assign(f, function(t) {
                        ...
                        return t;
                    }({}, j)), l > 0 && t.lag(g, l), v.push("".concat(m, "_upper"), "".concat(m, "_basis"), "".concat(m, "_lower")), 
                ...
                var _ = h.donchian_channel.numberOfIndicators > 1 ? "donchian_channel_".concat(s) : "donchian_channel", P = h.donchian_channel.settings[s], A = P.maxDeque, E = P.minDeque, M = e - n, x = M + 1, k = x - r;
                ...
                try {
                    for (U.s(); !(H = U.n()).done; ) {
                        var z = H.value, q = null, $ = f[z][e];
                        "number" == typeof $ && "number" == typeof V && "number" == typeof B && V - B != 0 && (q = c ? Math.max(Math.min(($ - B) / (V - B), 1), 0) : ($ - B) / (V - B), 
                        u && (q = ne(q, u))), t.pushToMain({
                            index: e,
                            key: "".concat(_, "_range_").concat(z),
                            value: q
                        });
                    }
                } catch (t) {
            ...
            bollingerBands: function(t, e, r, n, o) {
                var i, a, u, l, c, s, f, h = o.height, y = o.range, p = void 0 === y ? [] : y, v = o.target, b = o.scale, d = o.lag, m = o.autoMinMax, g = t.verticalOhlcv, w = t.instances, O = t.lastIndexReplace, S = "close" === v ? "" : "_".concat(v), j = "".concat(r, "_").concat(n).concat(S);
                // Initialization on the first call.
                if (0 === e) {
                    var _ = t.priceBased, P = t.inputParams, A = t.nullArray, E = t.verticalOhlcv;
                    ...
                    f = M > 1 ? "bollinger_bands_".concat(j) : "bollinger_bands".concat(S), 
                    ...
                    w.bollinger_bands.settings[j] = new jt(r, n);
                    ...
                    try {
                        for (T.s(); !(k = T.n()).done; ) {
                            var I = k.value;
                            if (!(I in E) || !_.includes(I)) throw new Error('Invalid range item value "'.concat(I, '" property for bollingerBands. Only price based key names are accepted:\n').concat(JSON.stringify(_)));
                    ...
                    Object.assign(E, function(t) {
                        ...
                        return t;
                    }({}, C)), d > 0 && t.lag(x, d), _.push("".concat(f, "_upper"), "".concat(f, "_middle"), "".concat(f, "_lower"));
                }
                // Derive prefix for subsequent calls if not set.
                                f || (f = w.bollinger_bands.numberOfIndicators > 1 ? "bollinger_bands_".concat(j) : "bollinger_bands".concat(S));
                var R = f, D = w.bollinger_bands.settings[j], V = g[v][e];
            ...
            volumeOscillator: function(t, e, r, n, o) {
                ...
                var m = null;
                return "number" == typeof b && "number" == typeof d && 0 !== d && (m = 100 * (b - d) / d, 
            ...
            candleVectors: function(t, e, r, n) {
                ...
                if (0 === e) {
                    for (var s = t.nullArray, f = [ [ "close", "open" ], [ "close", "high" ], [ "close", "low" ], [ "open", "high" ], [ "open", "low" ], [ "high", "low" ] ], h = [ [ "open", "open" ], [ "high", "high" ], [ "low", "low" ], [ "close", "close" ] ].concat(f), y = [], p = {}, v = 0; v < o; v++) {
                        ...
                        try {
                            for (d.s(); !(b = d.n()).done; ) {
                                var m = Ge(b.value, 2), g = m[0], w = m[1];
                                y.push("candle_change_".concat(v + 1, "_").concat(g, "_").concat(w)), p["candle_change_".concat(v + 1, "_").concat(g, "_").concat(w)] = Ke(s), 
                    ...
                    for (var O = [], S = {}, j = 0, _ = f; j < _.length; j++) {
                        var P = Ge(_[j], 2), A = P[0], E = P[1];
                        O.push("candle_body_".concat(A, "_").concat(E)), S["candle_body_".concat(A, "_").concat(E)] = Ke(s), 
                        a && t.autoMinMaxKeys.push("candle_body_".concat(A, "_").concat(E));
                    }
                    var M = [].concat(O, y);
                    Object.assign(u, $e($e({}, S), p)), Object.assign(l, {
                        candleVectors: {
                            bodyVectors: f,
                            lookBackVectors: h,
                            keyNames: M,
                            arrayChunk: $e({}, Object.fromEntries(M.map((function(t) {
                                return [ t, [] ];
                            }))))
                        }
                    }), i > 0 && t.lag(M, i);
                ...
                for (var x = l.candleVectors, k = x.bodyVectors, T = x.lookBackVectors, I = x.arrayChunk, C = 0; C < k.length; C++) {
                    var R = Ge(k[C], 2), D = R[0], V = R[1], B = u[D][e], N = u[V][e], L = "candle_body_".concat(D, "_").concat(V), H = Qe(B, N), U = se(I, L, r, H, c);
                    t.pushToMain({
                        index: e,
                        key: L,
                        value: U
                ...
                for (var z = 0; z < o; z++) {
                    ...
                    try {
                        for ($.s(); !(q = $.n()).done; ) {
                            var F = Ge(q.value, 2), K = F[0], G = F[1], J = u[K][e], W = u[G][e - (z + 1)], Y = "candle_change_".concat(z + 1, "_").concat(K, "_").concat(G);
                            if (void 0 !== W) {
                                var Q = Qe(J, W), X = se(I, Y, r, Q, c);
                                t.pushToMain({
                                    index: e,
                                    key: Y,
                                    value: X
 ...
 // Optionally: throw an error if type is not recognized
            ...
            if (0 === n) {
                ...
                !function(t) {
                    ...
                    e.verticalOhlcv[t] = jr(e.nullArray);
                }));
            ...
            for (var s = function(t) {
                ...
                var h = t[f], y = h.open, p = h.high, v = h.low, b = h.close, d = Sr(h, wr), m = e.precisionMultiplier, g = Mr(y, e.inputTypes.open, m), w = Mr(p, e.inputTypes.high, m), O = Mr(v, e.inputTypes.low, m), S = Mr(b, e.inputTypes.close, m);
                ...
                //sets volume to 0
                    ...
                    var j = h.volume, _ = xr(j, e.inputTypes.volume);
                    e.pushToMain({
                        index: f,
                        key: "volume",
                        value: _
                ...
                try {
                    for (x.s(); !(M = x.n()).done; ) {
                        ...
                        [ "crossPairs", "lag" ].includes(T) || I.apply(void 0, [ e, f ].concat(jr(C)));
                    }
                ...
                or(e, f), pr(e, f), e.lastComputedIndex++;
            }
        }, Tr = function(t, e) {
            ...
            for (var n = Tr(t, r), o = Tr(e, r), i = t.length, a = [], u = 0, l = 0, c = 0, s = 0, f = 0, h = 0, y = -1, p = 0; p < i; p++) {
            ...
            for (var v = y; v < i; v++) {
                var b = n[v], d = o[v];
                if (null !== b && null !== d) if (u += b, l += d, c += b * d, s += b * b, f += d * d, 
                ++h < 2) a.push(0); else {
 ...
 * OHLCV datasets.
 */ (t, "string");
            return "symbol" == Rr(e) ? e : e + "";
        }
        var Hr = [ .001, .002, .0025, .005, .01, .02, .025, .05, .1, .2, .25, .5, 1, 2, 2.5, 5, 10 ], Ur =  function() {
            return t = function t(e) {
                ...
                value: function() {
                    ...
                    for (var e = this.precisionMultiplier, r = this.precision, n = this.invalidValueIndex, o = this.len, i = this.verticalOhlcv, a = this.priceBased, u = {}, l = n >= 0 && t, c = o - (n + 1), s = 0, f = Object.entries(i); s < f.length; s++) {
                        var h = Dr(f[s], 2), y = h[0], p = h[1], v = l ? p.slice(-c) : p;
                ...
                value: function(t) {
                    ...
                    this.len > this.lastComputedIndex && !t && kr(this.input, this, 0), t && "object" === Rr(t)) {
                        var e;
                        ...
                        // Add new item
                        this.len++, this.input.push(t), kr(this.input, this, this.len)) : (
                        // Modify the last item
                        this.input[n] = t, kr(this.input, this, n));
                    }
                    return this;
                }
            }, {
                key: "crossPairs",
                value: function(t) {
                    return i(this), this.crossPairsList = [].concat(Cr(this.crossPairsList), Cr(t)), 
                ...
                value: function(t) {
                    ...
                    if ("number" == typeof n && !Hr.includes(n)) throw new Error('"scale" value in relativeVolume must be any of the following numbers: '.concat(Hr.join(", ")));
                ...
                value: function() {
                    ...
                    if ("object" !== Rr(n)) throw new Error('"options" must be an object in macd. eg: {target}');
                ...
                value: function() {
                    ...
                    if (i(this), !r || "object" !== Rr(r)) throw new Error('"options" must be an object in bollingerBands. eg: {target, height, range}');
                    ...
                    if ("number" == typeof f && !Hr.includes(f)) throw new Error('"scale" value in bollingerBands must be any of the following numbers: '.concat(Hr.join(", ")));
                    return this.inputParams.push({
                        key: "bollingerBands",
                        params: [ t, e, {
                            target: o,
                ...
                value: function(t) {
                    ...
                    if ("number" == typeof n && !Hr.includes(n)) throw new Error('"scale" value in rsi must be any of the following numbers: '.concat(Hr.join(", ")));
                ...
                value: function() {
                    ...
                    if ("number" == typeof c && !Hr.includes(c)) throw new Error('"scale" value in donchianChannels must be any of the following numbers: '.concat(Hr.join(", ")));
                    return this.inputParams.push({
                        key: "donchianChannels",
                        params: [ t, e, {
                            height: o,
                ...
                value: function() {
                    ...
                    if ("number" == typeof l && !Hr.includes(l)) throw new Error('"scale" value in candleVectors must be any of the following numbers: '.concat(Hr.join(", ")));
                ...
                value: function() {
                    ...
                    if ("number" == typeof o && !Hr.includes(o)) throw new Error('"scale" value in volumeOscillator must be any of the following numbers: '.concat(Hr.join(", ")));
                    return this.inputParams.push({
                        key: "volumeOscillator",
                        params: [ t, e, {
                            scale: o
            ...
            } ], e && Nr(t.prototype, e), r && Nr(t, r), Object.defineProperty(t, "prototype", {
                writable: !1
            }), t;
            var t, e, r;
        }();
